...
export function ResourceCard({ resource }: { resource: Resource }) {
  const customLinks: Record<string, string> = {
    "Academic Programme": "/official/academic-programme",
    "Academic Courses": "/official/academic-courses",
    "Class Timetable": "/official/class-timetable",
  };

  const href = customLinks[resource.title] || resource.url;
  const external = !customLinks[resource.title];
